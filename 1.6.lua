...
local SETTINGS = {
    ...
    Combat = {
        ...
        FastAttackCooldown = 1, FastAttack200x = false, -- Tính năng mới
...
local function miscFeatures()
    ...
    manageLockFPS()
    manageFastAttack()
    manageFastAttack200x() -- khởi động quản lý 200x nếu được bật từ đầu
