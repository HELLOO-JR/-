...
local SETTINGS = {
    AutoFarm = {Enabled = true, Method = "Quest", Distance = 100, AutoStats = true, Stats = "Melee", AutoSkills = true, CollectDrops = true, AutoSell = false, AutoBuy = false, FastMode = false},
    FruitSniper = {Enabled = true, AutoCollect = true, AutoStore = true, StorePercentage = 80, FruitBlacklist = {"Bomb-Bomb", "Spike-Spike", "Spin-Spin", "Spring-Spring", "Kilo-Kilo", "Smoke-Smoke", "Rocket-Rocket", "Falcon-Falcon", "Chop-Chop"}, AutoServerHop = true, ServerHopDelay = 3, AutoNotifier = true, WebhookURL = ""},
    AutoRaid = {Enabled = false, Type = "Flame", AutoNext = true, AutoBuyChip = true, AutoAwaken = false},
    AutoMastery = {Enabled = false, Weapon = "Current"},
    AutoBoss = {Enabled = false, BossList = {"Diamond", "Jeremy", "Fajita", "Don Swan", "Smoke Admiral", "Greybeard", "rip_indra", "Tide Keeper", "Beautiful Pirate", "Longma", "Cursed Captain", "Captain Elephant", "Stone", "Island Empress", "Warden", "Chief Warden", "Magma Admiral", "Fishman Lord", "Vice Admiral", "Ice Admiral", "Tank", "Spy", "Hydra Leader"}, AutoNext = true, AutoReward = true},
    AutoSeaEvents = {Enabled = false, SeaBeast = true, ShipRaid = true, AutoReward = true, AutoSummon = false},
    ESP = {Enabled = true, PlayerESP = true, FruitESP = true, EnemyESP = true, ChestESP = true, ESPDistance = 2000, ShowHealth = true, ShowDistance = true, ShowName = true, Tracers = true, BoxESP = true, Chams = false},
    Teleports = {FastTeleport = true, TweenSpeed = 250, AutoAvoidWater = true, WaterTP = true, SafeMode = false},
    Combat = {Godmode = false, InfiniteEnergy = false, NoStun = true, AutoDodge = false, KillAura = false, KillAuraRange = 30, FastAttack = false, AutoBounty = false, AutoKenHaki = false, AutoBusoHaki = false, AutoSoru = false, AutoObservationV2 = false, AutoFlashStep = false, NoClip = false, HitboxExpander = false, HitboxSize = 15, AutoBlock = false, PerfectBlock = false},
    Movement = {SpeedHack = 0, JumpPower = 0, Fly = false, FlySpeed = 50, Noclip = false, Invisible = false, NoFallDamage = true, AutoSwim = true, InfinityJump = false, AutoDash = false, WalkOnWater = false},
    AutoQuest = {Enabled = true, SkipDialog = true, AutoComplete = true, AutoStart = true},
    AutoStats = {Enabled = true, AutoUpgrade = true, UpgradeOrder = {"Melee", "Defense", "Sword", "Gun", "BloxFruit"}, PointsPerUpgrade = 3},
    AntiAFK = {Enabled = true, Interval = 600},
    AutoRejoin = {Enabled = false, Interval = 1800, AutoRejoinOnKick = true},
    Misc = {AutoHaki = true, AutoRaceV4 = false, MirageFinder = false, ChestFarm = false, FPSBoost = true, WhiteScreen = false, NoFog = true, AutoBone = false, AutoEctoplasm = false, AutoFragment = false, AutoCandy = false, AutoGems = false, AutoMoney = false, AutoDrop = false, AutoLegendarySword = false, AutoYama = false, AutoTushita = false, AutoCursedDual = false, AutoTrueTriple = false, AutoHallowScythe = false, AutoDarkDagger = false, AutoFoxLamp = false, AutoSharkAnchor = false, AutoSpikeyTrident = false, AutoDragonTrident = false, AutoGravityCane = false, AutoSoulCane = false, AutoDualHeaded = false, AutoPoleV2 = false, AutoBuddySword = false, AutoCavender = false},
    Webhook = {Enabled = false, URL = "", NotifyBoss = true, NotifyFruit = true, NotifyRaid = true, NotifySeaEvent = true, NotifyDeath = true, NotifyLevelUp = true, NotifyBounty = true, AutoExecute = false, DiscordRPC = false},
    RaceV4 = {AutoTrial = false, AutoLeviathan = false, AutoDoughKing = false, AutoCakePrince = false, AutoMirage = false},
    Puzzles = {AutoSoulGuitar = false, AutoMirrorFractal = false, AutoRaceAwakening = false, AutoButton = false},
    Factory = {AutoFactory = false, AutoCore = false, AutoCollect = false},
    EliteHunter = {AutoElite = false, AutoNext = true, AutoReward = true},
    Dungeon = {AutoDungeon = false, AutoStart = false, AutoClear = false, AutoReward = true},
    ThirdSea = {AutoThirdSea = false, AutoPvP = false, AutoBountyHunt = false, BountyThreshold = 2500000},
    Performance = {FixLag = true, LowGraphics = true, NoParticles = true, NoShadows = true, NoTextures = false, RenderDistance = 500, DisableAudio = true, ClearWorkspace = true, OptimizeMemory = true, UnloadUnused = true, FPSUnlocker = true, MaxFPS = 240, LowQualityTerrain = true, DisableDecals = true, NoWaterReflection = true, NoLighting = true, DisableBloom = true, DisableDepthOfField = true, DisableMotionBlur = true, DisableColorCorrection = true, DisableSunRays = true},
    AutoServerHop = {Enabled = false, MinPlayers = 5, MaxPlayers = 30, HopOnBossSpawn = true, HopOnFruitFound = true, SafeServer = false, HopDelay = 10},
    AutoChat = {Enabled = false, Messages = {"Hello!", "GL HF", "GG", "Nice!"}, Interval = 60, RandomMessages = true},
    AutoTrade = {Enabled = false, AutoAccept = false, AutoDecline = false, Whitelist = {}, Blacklist = {}},
    AutoVote = {Enabled = false, AutoSkip = false, AutoYes = false},
    AutoShop = {Enabled = false, AutoBuyFruit = false, FruitBudget = 1000000, AutoBuyWeapon = false, WeaponList = {}},
    AutoSpin = {Enabled = false, AutoSpinFruit = false, SpinCount = 10, StopOnMythical = true},
    AutoTitle = {Enabled = false, TitleList = {}},
    AutoEmote = {Enabled = false, EmoteList = {}, Interval = 30},
    AutoStun = {Enabled = false, StunAll = false, Range = 50},
    AutoFarmCocoa = {Enabled = false, AutoCollect = true},
    AutoFarmCake = {Enabled = false, AutoBake = true},
    AutoFarmDragon = {Enabled = false, AutoCollect = true},
    AutoFarmBones = {Enabled = false, AutoCollect = true},
    AutoFarmEctoplasm = {Enabled = false, AutoCollect = true},
    AutoFarmFragment = {Enabled = false, AutoCollect = true},
    AutoFarmGems = {Enabled = false, AutoCollect = true},
    AutoFarmMoney = {Enabled = false, AutoCollect = true},
    AutoFarmMastery = {Enabled = false, AutoSwitch = true},
    AutoFarmLevel = {Enabled = false, AutoBuyXP = true, AutoBoost = true},
    AutoPvP = {Enabled = false, AutoCombo = true, ComboList = {}, AutoRun = false, HealthThreshold = 30},
    AutoTeam = {Enabled = false, AutoJoin = false, AutoCreate = false, TeamName = ""},
    AutoAlly = {Enabled = false, AllyList = {}},
    AutoEnemy = {Enabled = false, EnemyList = {}},
    AutoBountyBoard = {Enabled = false, AutoClaim = true},
    AutoHakiColor = {Enabled = false, AutoUnlock = true, TargetColor = "Pure Red"},
    AutoTitleUnlock = {Enabled = false, TitleList = {}},
    AutoChest = {Enabled = false, AutoOpen = true, Range = 100},
    AutoDevilFruitShop = {Enabled = false, AutoBuy = true, Budget = 5000000, TargetFruit = ""},
    AutoAbility = {Enabled = false, AutoUnlock = true, TargetAbility = ""},
    AutoSwordUpgrade = {Enabled = false, AutoUpgrade = true, TargetEnchant = ""},
    AutoGunUpgrade = {Enabled = false, AutoUpgrade = true, TargetEnchant = ""},
    AutoAccessories = {Enabled = false, AutoEquip = true, TargetAccessory = ""},
    AutoMaterialFarm = {Enabled = false, Materials = {}},
    AutoFish = {Enabled = false, AutoCatch = true},
    AutoSmelt = {Enabled = false, AutoSmeltOre = true},
    AutoCook = {Enabled = false, AutoCookFood = true},
    AutoDrink = {Enabled = false, AutoDrinkPotion = true},
    AutoCraft = {Enabled = false, AutoCraftItem = true},
    AutoEnchant = {Enabled = false, AutoEnchantWeapon = true},
    AutoAwakenFruit = {Enabled = false, AutoAwaken = true, TargetFruit = ""},
    AutoRaceV2 = {Enabled = false, AutoUpgrade = true},
    AutoRaceV3 = {Enabled = false, AutoUpgrade = true},
    AutoObservation = {Enabled = false, AutoUnlock = true},
    AutoSoruMastery = {Enabled = false, AutoTrain = true},
    AutoFlashStepMastery = {Enabled = false, AutoTrain = true},
    AutoBusoHakiMastery = {Enabled = false, AutoTrain = true},
    AutoKenHakiMastery = {Enabled = false, AutoTrain = true},
    AutoSwordMastery = {Enabled = false, AutoTrain = true},
    AutoGunMastery = {Enabled = false, AutoTrain = true},
    AutoFruitMastery = {Enabled = false, AutoTrain = true},
    AutoFightingStyleMastery = {Enabled = false, AutoTrain = true},
    AutoMeleeMastery = {Enabled = false, AutoTrain = true},
    AutoDefenseMastery = {Enabled = false, AutoTrain = true},
    AutoBellyFarm = {Enabled = false, AutoCollect = true},
    AutoFragmentFarm = {Enabled = false, AutoCollect = true},
    AutoBoneFarm = {Enabled = false, AutoCollect = true},
    AutoEctoplasmFarm = {Enabled = false, AutoCollect = true},
    AutoCocoaFarm = {Enabled = false, AutoCollect = true},
    AutoCakeFarm = {Enabled = false, AutoCollect = true},
    AutoDragonFarm = {Enabled = false, AutoCollect = true},
    AutoLeviathanFarm = {Enabled = false, AutoFight = true},
    AutoDoughKingFarm = {Enabled = false, AutoFight = true},
    AutoCakePrinceFarm = {Enabled = false, AutoFight = true},
    AutoMirageFarm = {Enabled = false, AutoFind = true},
    AutoSoulGuitarPuzzle = {Enabled = false, AutoSolve = true},
    AutoMirrorFractalPuzzle = {Enabled = false, AutoSolve = true},
    AutoButtonPuzzle = {Enabled = false, AutoSolve = true},
    AutoYamaPuzzle = {Enabled = false, AutoSolve = true},
    AutoTushitaPuzzle = {Enabled = false, AutoSolve = true},
    AutoCursedDualPuzzle = {Enabled = false, AutoSolve = true},
    AutoTrueTriplePuzzle = {Enabled = false, AutoSolve = true},
    AutoHallowScythePuzzle = {Enabled = false, AutoSolve = true},
    AutoDarkDaggerPuzzle = {Enabled = false, AutoSolve = true},
    AutoFoxLampPuzzle = {Enabled = false, AutoSolve = true},
    AutoSharkAnchorPuzzle = {Enabled = false, AutoSolve = true},
    AutoBuddySwordPuzzle = {Enabled = false, AutoSolve = true},
    AutoCavenderPuzzle = {Enabled = false, AutoSolve = true},
    AutoPoleV2Puzzle = {Enabled = false, AutoSolve = true},
    AutoDualHeadedPuzzle = {Enabled = false, AutoSolve = true},
    AutoSoulCanePuzzle = {Enabled = false, AutoSolve = true},
    AutoGravityCanePuzzle = {Enabled = false, AutoSolve = true},
    AutoDragonTridentPuzzle = {Enabled = false, AutoSolve = true},
    AutoSpikeyTridentPuzzle = {Enabled = false, AutoSolve = true},
    AutoLegendarySwordDealer = {Enabled = false, AutoBuy = true, Budget = 2000000},
    AutoMysteriousMan = {Enabled = false, AutoBuy = true},
    AutoAdvancedFruitDealer = {Enabled = false, AutoBuy = true, Budget = 10000000},
    AutoStockRefresh = {Enabled = false, RefreshInterval = 3600},
    AutoSeaBeastSummoner = {Enabled = false, AutoSummon = true},
    AutoShipDealer = {Enabled = false, AutoBuy = true, TargetShip = ""},
    AutoShipwright = {Enabled = false, AutoRepair = true},
    AutoLibrarian = {Enabled = false, AutoBuy = true},
    AutoAlchemist = {Enabled = false, AutoBuy = true},
    AutoBlacksmith = {Enabled = false, AutoUpgrade = true},
    AutoEnchanter = {Enabled = false, AutoEnchant = true},
    AutoRefinery = {Enabled = false, AutoRefine = true},
    AutoCookingChef = {Enabled = false, AutoCook = true},
    AutoBartender = {Enabled = false, AutoBuy = true},
    AutoDoctor = {Enabled = false, AutoHeal = true},
    AutoQuestNPC = {Enabled = false, AutoTalk = true},
    AutoBoatNPC = {Enabled = false, AutoRent = true},
    AutoInfoNPC = {Enabled = false, AutoRead = true},
    AutoMiscNPC = {Enabled = false, AutoInteract = true},
}
...
local State = {
    ...
    Connections = {}, LastAttack = 0, LastServerHop = 0, LastRejoin = tick(),
    LastWebhookSend = {}, Tracers = {}, BoxESP = {}, Chams = {},
    OriginalMaterials = {}, PerformanceOptimized = false, GUILoaded = false,
    CachedEnemies = {}, CachedPlayers = {}, CachedFruits = {}, CachedChests = {},
    TeleportHistory = {}, CombatCooldowns = {}, SkillCooldowns = {},
    MemoryUsage = 0, FPS = 0, Ping = 0, LastGCC = tick(), LastMemoryClean = tick(),
}
...
local function teleportTo(targetPosition, instant)
    ...
    table.insert(State.TeleportHistory, {time = tick(), pos = targetPosition})
    if #State.TeleportHistory > 100 then table.remove(State.TeleportHistory, 1) end
end
...
local function sendWebhook(eventType, data)
    if not SETTINGS.Webhook.Enabled or SETTINGS.Webhook.URL == "" then return end
    local timeSinceLastSend = State.LastWebhookSend[eventType] or 0
    if tick() - timeSinceLastSend < 5 then return end
    State.LastWebhookSend[eventType] = tick()
    task.spawn(function()
        pcall(function()
            local embed = {title = "Blox Fruits - " .. eventType, description = data, color = 16711680, timestamp = os.date("!%Y-%m-%dT%H:%M:%SZ")}
            local payload = HttpService:JSONEncode({embeds = {embed}})
            HttpService:PostAsync(SETTINGS.Webhook.URL, payload, Enum.HttpContentType.ApplicationJson)
        end)
    end)
end
    ...
    task.spawn(function()
        pcall(function()
            ...
            if SETTINGS.Performance.NoWaterReflection then
                game:GetService("Players").LocalPlayer.PlayerScripts.Scripts.Client["WaterReflection"]:Destroy()
            end
            ...
            while SETTINGS.Performance.FixLag do
                pcall(function()
                    ...
                    if SETTINGS.Performance.OptimizeMemory then
                        if tick() - State.LastMemoryClean > 60 then
                            State.LastMemoryClean = tick()
...
local function createFuturisticGUI()
    ...
    addSectionLabel(TabPages["🏠 Home"], "Select a category to begin")
    addButton(TabPages["🏠 Home"], "🚀 Optimize Performance", optimizePerformance)
    addButton(TabPages["🏠 Home"], "🔄 Server Hop", serverHop)
    addButton(TabPages["🏠 Home"], "💾 Save Settings", function() notify("Saved", "Settings saved!", 2) end)
    ...
    addSectionLabel(TabPages["🎯 Boss"], "Elite Hunter")
    addToggle(TabPages["🎯 Boss"], "Auto Elite", SETTINGS.EliteHunter, "AutoElite")
    ...
    addToggle(TabPages["🔧 Misc"], "Auto Bone Farm", SETTINGS.Misc, "AutoBone")
    addToggle(TabPages["🔧 Misc"], "Auto Ectoplasm", SETTINGS.Misc, "AutoEctoplasm")
    addToggle(TabPages["🔧 Misc"], "Auto Fragment", SETTINGS.Misc, "AutoFragment")
    ...
    addSectionLabel(TabPages["📜 Puzzles"], "Auto Puzzles")
    addToggle(TabPages["📜 Puzzles"], "Auto Soul Guitar", SETTINGS.Puzzles, "AutoSoulGuitar")
    addToggle(TabPages["📜 Puzzles"], "Auto Mirror Fractal", SETTINGS.Puzzles, "AutoMirrorFractal")
    addToggle(TabPages["📜 Puzzles"], "Auto Yama", SETTINGS.AutoYamaPuzzle, "AutoSolve")
    addToggle(TabPages["📜 Puzzles"], "Auto Tushita", SETTINGS.AutoTushitaPuzzle, "AutoSolve")

    addSectionLabel(TabPages["🗡️ Swords"], "Legendary Swords")
    addToggle(TabPages["🗡️ Swords"], "Auto Legendary Sword", SETTINGS.Misc, "AutoLegendarySword")
    addToggle(TabPages["🗡️ Swords"], "Auto Yama", SETTINGS.Misc, "AutoYama")
    addToggle(TabPages["🗡️ Swords"], "Auto Tushita", SETTINGS.Misc, "AutoTushita")
    addToggle(TabPages["🗡️ Swords"], "Auto Cursed Dual", SETTINGS.Misc, "AutoCursedDual")
    addToggle(TabPages["🗡️ Swords"], "Auto True Triple", SETTINGS.Misc, "AutoTrueTriple")
    addToggle(TabPages["🗡️ Swords"], "Auto Hallow Scythe", SETTINGS.Misc, "AutoHallowScythe")
    addToggle(TabPages["🗡️ Swords"], "Auto Dark Dagger", SETTINGS.Misc, "AutoDarkDagger")
    addToggle(TabPages["🗡️ Swords"], "Auto Fox Lamp", SETTINGS.Misc, "AutoFoxLamp")
    addToggle(TabPages["🗡️ Swords"], "Auto Shark Anchor", SETTINGS.Misc, "AutoSharkAnchor")
    addToggle(TabPages["🗡️ Swords"], "Auto Spikey Trident", SETTINGS.Misc, "AutoSpikeyTrident")
    addToggle(TabPages["🗡️ Swords"], "Auto Dragon Trident", SETTINGS.Misc, "AutoDragonTrident")
    addToggle(TabPages["🗡️ Swords"], "Auto Gravity Cane", SETTINGS.Misc, "AutoGravityCane")
    addToggle(TabPages["🗡️ Swords"], "Auto Soul Cane", SETTINGS.Misc, "AutoSoulCane")
    addToggle(TabPages["🗡️ Swords"], "Auto Dual Headed", SETTINGS.Misc, "AutoDualHeaded")
    addToggle(TabPages["🗡️ Swords"], "Auto Pole V2", SETTINGS.Misc, "AutoPoleV2")
    addToggle(TabPages["🗡️ Swords"], "Auto Buddy Sword", SETTINGS.Misc, "AutoBuddySword")
    addToggle(TabPages["🗡️ Swords"], "Auto Cavender", SETTINGS.Misc, "AutoCavender")

    addSectionLabel(TabPages["⚡ Mastery"], "Auto Mastery")
    addToggle(TabPages["⚡ Mastery"], "Auto Mastery", SETTINGS.AutoMastery, "Enabled")
    addToggle(TabPages["⚡ Mastery"], "Auto Sword Mastery", SETTINGS.AutoSwordMastery, "AutoTrain")
    addToggle(TabPages["⚡ Mastery"], "Auto Gun Mastery", SETTINGS.AutoGunMastery, "AutoTrain")
    addToggle(TabPages["⚡ Mastery"], "Auto Fruit Mastery", SETTINGS.AutoFruitMastery, "AutoTrain")
    addToggle(TabPages["⚡ Mastery"], "Auto Melee Mastery", SETTINGS.AutoMeleeMastery, "AutoTrain")
    addToggle(TabPages["⚡ Mastery"], "Auto Defense Mastery", SETTINGS.AutoDefenseMastery, "AutoTrain")

    addSectionLabel(TabPages["🎪 Events"], "Auto Events")
    addToggle(TabPages["🎪 Events"], "Auto Factory", SETTINGS.Factory, "AutoFactory")
    addToggle(TabPages["🎪 Events"], "Auto Dungeon", SETTINGS.Dungeon, "AutoDungeon")
    ...
    task.spawn(function()
        while true do
            ...
            if fruit and dist <= 500 then
                ...
                if SETTINGS.Webhook.Enabled and SETTINGS.Webhook.NotifyFruit then sendWebhook("Devil Fruit Found", fruitName) end
    ...
    task.spawn(function()
        while true do
            ...
            if boss and dist <= 200 then
                ...
                task.wait(0.5)
                attackTarget(boss)
                if SETTINGS.Webhook.Enabled and SETTINGS.Webhook.NotifyBoss then sendWebhook("Boss Fight", boss.Name) end
            else
...
local function combatFeatures()
    if SETTINGS.Combat.Godmode then
        task.spawn(function()
            while SETTINGS.Combat.Godmode do
    ...
    if SETTINGS.Combat.InfiniteEnergy then
        task.spawn(function()
            while SETTINGS.Combat.InfiniteEnergy do
    ...
    if SETTINGS.Combat.NoStun then
        task.spawn(function()
            while SETTINGS.Combat.NoStun do
    ...
    if SETTINGS.Combat.AutoKenHaki then
        task.spawn(function()
            while SETTINGS.Combat.AutoKenHaki do
    ...
    if SETTINGS.Combat.AutoBusoHaki then
        task.spawn(function()
            while SETTINGS.Combat.AutoBusoHaki do
    ...
    if SETTINGS.Combat.AutoSoru then
        task.spawn(function()
            while SETTINGS.Combat.AutoSoru do
...
local function movementFeatures()
    ...
    if SETTINGS.Movement.Noclip then
        task.spawn(function()
            while SETTINGS.Movement.Noclip do
                pcall(function() for _, p in ipairs(Character:GetDescendants()) do if p:IsA("BasePart") then p.CanCollide = false end end end)
                task.wait(0.5)
            end
            pcall(function() for _, p in ipairs(Character:GetDescendants()) do if p:IsA("BasePart") then p.CanCollide = true end end end)
        end)
    end
    if SETTINGS.Movement.Invisible then
        task.spawn(function()
            while SETTINGS.Movement.Invisible do
            ...
            pcall(function() for _, p in ipairs(Character:GetDescendants()) do if p:IsA("BasePart") then p.Transparency = 0 end end end)
        end)
    end
    ...
    if SETTINGS.Movement.InfinityJump then
        task.spawn(function()
            while SETTINGS.Movement.InfinityJump do
...
local function autoStats()
    task.spawn(function()
        while true do
            if not SETTINGS.AutoStats.Enabled or not SETTINGS.AutoStats.AutoUpgrade then task.wait(5); continue end
            pcall(function()
...
local function autoRejoin()
    if not SETTINGS.AutoRejoin.Enabled then return end
    task.spawn(function()
        while SETTINGS.AutoRejoin.Enabled do
            if tick() - State.LastRejoin >= SETTINGS.AutoRejoin.Interval then
...
local function initialize()
    ...
    notify("Ryzen AI", "Blox Fruits All-in-One Script Loaded!", 5)
    optimizePerformance()
    createFuturisticGUI()
    autoFarm()
    fruitSniper()
