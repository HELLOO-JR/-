...
local SETTINGS = {
    ...
    Misc = {AutoHaki = false, AutoRaceV4 = false, MirageFinder = false, ChestFarm = false, FPSBoost = false, WhiteScreen = false, NoFog = false, AutoBone = false, AutoEctoplasm = false, AutoFragment = false, AutoCandy = false, AutoGems = false, AutoMoney = false, AutoDrop = false, AutoLegendarySword = false, AutoYama = false, AutoTushita = false, AutoCursedDual = false, AutoTrueTriple = false, AutoHallowScythe = false, AutoDarkDagger = false, AutoFoxLamp = false, AutoSharkAnchor = false, AutoSpikeyTrident = false, AutoDragonTrident = false, AutoGravityCane = false, AutoSoulCane = false, AutoDualHeaded = false, AutoPoleV2 = false, AutoBuddySword = false, AutoCavender = false},
    Webhook = {Enabled = false, URL = "", NotifyBoss = false, NotifyFruit = false, NotifyRaid = false, NotifySeaEvent = false, NotifyDeath = false, NotifyLevelUp = false, NotifyBounty = false, AutoExecute = false, DiscordRPC = false},
    ...
    EliteHunter = {AutoElite = false, AutoNext = false, AutoReward = false},
    Dungeon = {AutoDungeon = false, AutoStart = false, AutoClear = false, AutoReward = false},
    ThirdSea = {AutoThirdSea = false, AutoPvP = false, AutoBountyHunt = false, BountyThreshold = 2500000},
    Performance = {FixLag = false, LowGraphics = false, NoParticles = false, NoShadows = false, NoTextures = false, RenderDistance = 500, DisableAudio = false, ClearWorkspace = false, OptimizeMemory = false, UnloadUnused = false, FPSUnlocker = false, MaxFPS = 240, LowQualityTerrain = false, DisableDecals = false, NoWaterReflection = false, NoLighting = false, DisableBloom = false, DisableDepthOfField = false, DisableMotionBlur = false, DisableColorCorrection = false, DisableSunRays = false},
    ...
    AutoChat = {Enabled = false, Messages = {"Hello!", "GL HF", "GG", "Nice!"}, Interval = 60, RandomMessages = false},
    ...
    AutoSpin = {Enabled = false, AutoSpinFruit = false, SpinCount = 10, StopOnMythical = false},
    ...
    AutoFarmCocoa = {Enabled = false, AutoCollect = false},
    AutoFarmCake = {Enabled = false, AutoBake = false},
    AutoFarmDragon = {Enabled = false, AutoCollect = false},
    AutoFarmBones = {Enabled = false, AutoCollect = false},
    AutoFarmEctoplasm = {Enabled = false, AutoCollect = false},
    AutoFarmFragment = {Enabled = false, AutoCollect = false},
    AutoFarmGems = {Enabled = false, AutoCollect = false},
    AutoFarmMoney = {Enabled = false, AutoCollect = false},
    AutoFarmMastery = {Enabled = false, AutoSwitch = false},
    AutoFarmLevel = {Enabled = false, AutoBuyXP = false, AutoBoost = false},
    AutoPvP = {Enabled = false, AutoCombo = false, ComboList = {}, AutoRun = false, HealthThreshold = 30},
    ...
    AutoBountyBoard = {Enabled = false, AutoClaim = false},
    AutoHakiColor = {Enabled = false, AutoUnlock = false, TargetColor = "Pure Red"},
    AutoTitleUnlock = {Enabled = false, TitleList = {}},
    AutoChest = {Enabled = false, AutoOpen = false, Range = 100},
    AutoDevilFruitShop = {Enabled = false, AutoBuy = false, Budget = 5000000, TargetFruit = ""},
    AutoAbility = {Enabled = false, AutoUnlock = false, TargetAbility = ""},
    AutoSwordUpgrade = {Enabled = false, AutoUpgrade = false, TargetEnchant = ""},
    AutoGunUpgrade = {Enabled = false, AutoUpgrade = false, TargetEnchant = ""},
    AutoAccessories = {Enabled = false, AutoEquip = false, TargetAccessory = ""},
    AutoMaterialFarm = {Enabled = false, Materials = {}},
    AutoFish = {Enabled = false, AutoCatch = false},
    AutoSmelt = {Enabled = false, AutoSmeltOre = false},
    AutoCook = {Enabled = false, AutoCookFood = false},
    AutoDrink = {Enabled = false, AutoDrinkPotion = false},
    AutoCraft = {Enabled = false, AutoCraftItem = false},
    AutoEnchant = {Enabled = false, AutoEnchantWeapon = false},
    AutoAwakenFruit = {Enabled = false, AutoAwaken = false, TargetFruit = ""},
    AutoRaceV2 = {Enabled = false, AutoUpgrade = false},
    AutoRaceV3 = {Enabled = false, AutoUpgrade = false},
    AutoObservation = {Enabled = false, AutoUnlock = false},
    AutoSoruMastery = {Enabled = false, AutoTrain = false},
    AutoFlashStepMastery = {Enabled = false, AutoTrain = false},
    AutoBusoHakiMastery = {Enabled = false, AutoTrain = false},
    AutoKenHakiMastery = {Enabled = false, AutoTrain = false},
    AutoSwordMastery = {Enabled = false, AutoTrain = false},
    AutoGunMastery = {Enabled = false, AutoTrain = false},
    AutoFruitMastery = {Enabled = false, AutoTrain = false},
    AutoFightingStyleMastery = {Enabled = false, AutoTrain = false},
    AutoMeleeMastery = {Enabled = false, AutoTrain = false},
    AutoDefenseMastery = {Enabled = false, AutoTrain = false},
    AutoBellyFarm = {Enabled = false, AutoCollect = false},
    AutoFragmentFarm = {Enabled = false, AutoCollect = false},
    AutoBoneFarm = {Enabled = false, AutoCollect = false},
    AutoEctoplasmFarm = {Enabled = false, AutoCollect = false},
    AutoCocoaFarm = {Enabled = false, AutoCollect = false},
    AutoCakeFarm = {Enabled = false, AutoCollect = false},
    AutoDragonFarm = {Enabled = false, AutoCollect = false},
    AutoLeviathanFarm = {Enabled = false, AutoFight = false},
    AutoDoughKingFarm = {Enabled = false, AutoFight = false},
    AutoCakePrinceFarm = {Enabled = false, AutoFight = false},
    AutoMirageFarm = {Enabled = false, AutoFind = false},
    AutoSoulGuitarPuzzle = {Enabled = false, AutoSolve = false},
    AutoMirrorFractalPuzzle = {Enabled = false, AutoSolve = false},
    AutoButtonPuzzle = {Enabled = false, AutoSolve = false},
    AutoYamaPuzzle = {Enabled = false, AutoSolve = false},
    AutoTushitaPuzzle = {Enabled = false, AutoSolve = false},
    AutoCursedDualPuzzle = {Enabled = false, AutoSolve = false},
    AutoTrueTriplePuzzle = {Enabled = false, AutoSolve = false},
    AutoHallowScythePuzzle = {Enabled = false, AutoSolve = false},
    AutoDarkDaggerPuzzle = {Enabled = false, AutoSolve = false},
    AutoFoxLampPuzzle = {Enabled = false, AutoSolve = false},
    AutoSharkAnchorPuzzle = {Enabled = false, AutoSolve = false},
    AutoBuddySwordPuzzle = {Enabled = false, AutoSolve = false},
    AutoCavenderPuzzle = {Enabled = false, AutoSolve = false},
    AutoPoleV2Puzzle = {Enabled = false, AutoSolve = false},
    AutoDualHeadedPuzzle = {Enabled = false, AutoSolve = false},
    AutoSoulCanePuzzle = {Enabled = false, AutoSolve = false},
    AutoGravityCanePuzzle = {Enabled = false, AutoSolve = false},
    AutoDragonTridentPuzzle = {Enabled = false, AutoSolve = false},
    AutoSpikeyTridentPuzzle = {Enabled = false, AutoSolve = false},
    AutoLegendarySwordDealer = {Enabled = false, AutoBuy = false, Budget = 2000000},
    AutoMysteriousMan = {Enabled = false, AutoBuy = false},
    AutoAdvancedFruitDealer = {Enabled = false, AutoBuy = false, Budget = 10000000},
    AutoStockRefresh = {Enabled = false, RefreshInterval = 3600},
    AutoSeaBeastSummoner = {Enabled = false, AutoSummon = false},
    AutoShipDealer = {Enabled = false, AutoBuy = false, TargetShip = ""},
    AutoShipwright = {Enabled = false, AutoRepair = false},
    AutoLibrarian = {Enabled = false, AutoBuy = false},
    AutoAlchemist = {Enabled = false, AutoBuy = false},
    AutoBlacksmith = {Enabled = false, AutoUpgrade = false},
    AutoEnchanter = {Enabled = false, AutoEnchant = false},
    AutoRefinery = {Enabled = false, AutoRefine = false},
    AutoCookingChef = {Enabled = false, AutoCook = false},
    AutoBartender = {Enabled = false, AutoBuy = false},
    AutoDoctor = {Enabled = false, AutoHeal = false},
    AutoQuestNPC = {Enabled = false, AutoTalk = false},
    AutoBoatNPC = {Enabled = false, AutoRent = false},
    AutoInfoNPC = {Enabled = false, AutoRead = false},
    AutoMiscNPC = {Enabled = false, AutoInteract = false},
}
...
local function initialize()
    ...
    notify("Ryzen AI", "Blox Fruits All-in-One Script Loaded! All features are OFF by default.", 5)
    createFuturisticGUI()
    autoFarm()
    fruitSniper()
    autoBoss()
